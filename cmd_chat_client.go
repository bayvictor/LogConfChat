...
func Connect(g *gocui.Gui, v *gocui.View) error {
  ...
  fmt.Println("using remote host aS:"+remoteHost) // For debug
  } else {
  remoteHost = "localhost"
  fmt.Println("case2:default to localhost")
  }
 ...
 if len(os.Args) >2 {
  ...
  //var port = remoteHost+":9001" #+ os.Args[2]
  var port = remoteHost+":" + portnum
